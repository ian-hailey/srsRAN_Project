...
/// \brief Stub RX TM entity.
class rlc_rx_tm_entity : public rlc_rx_entity
{
public:
  rlc_rx_tm_entity(gnb_du_id_t          du_index_,
  ...
  void handle_pdu(byte_buffer_slice pdu) override { logger.warning("RX TM PDU not implemented"); }

private:
  rlc_rx_tm_config cfg;
};
